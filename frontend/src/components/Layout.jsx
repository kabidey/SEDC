...
import {
  ...
  User as UserIcon, Menu as MenuIcon, X,
} from 'lucide-react';
...
const ICON_MAP = { 'building-2': Building2, server: Server, 'columns-3': Columns3, cable: Cable, globe: Globe, route: Route, zap: Zap, box: Box, wifi: Wifi, shield: Shield, 'settings-2': Settings2, 'shield-check': ShieldCheck };
